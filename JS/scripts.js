...
function UserEntersLeftMatrixSize() {
  ...
  if (
    Number(leftMatrixColSize.value) > 0 &&
    Number(leftMatrixRowSize.value) > 0 &&
    Number(leftMatrixColSize.value) < 11 &&
    Number(leftMatrixRowSize.value) < 11
  ) {
...
function UserEntersRightMatrixSize() {
  //check if the sizes are valid
  if (
    Number(rightMatrixColSize.value) > 0 &&
    Number(rightMatrixRowSize.value) > 0 &&
    Number(rightMatrixColSize.value) < 11 &&
    Number(rightMatrixRowSize.value) < 11
  ) {
...
function AddMatrix(currLeftMat) {
  ...
  if (
    Number(rightMatrixRowSize.value) == Number(leftMatrixRowSize.value) &&
    Number(rightMatrixColSize.value) == Number(leftMatrixColSize.value)
  ) {
...
function MultiplyMatrix(currLeftMat) {
  ...
  if (Number(leftMatrixColSize.value) == Number(rightMatrixRowSize.value)) {
    ...
    for (let i = 0; i < Number(leftMatrixRowSize.value); i++) {
      ...
      let endPoint =
        i * Number(leftMatrixColSize.value) + Number(leftMatrixColSize.value);
      ...
      for (let j = 0; j < Number(rightMatrixColSize.value); j++) {
        ...
        for (
          let c = j;
          c < Number(rightMatrix.length);
          c += Number(rightMatrixColSize.value)
        ) {
